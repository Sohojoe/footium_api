...
from footium_api.queries import get_formations, get_lineup_for_club, get_server_timestamp
...
result = submit_lineup(gql, message=lineup_message, signed_message=signature, address=address)
